package net.mcreator.thepizzatowermod.block.entity;
...
public class PepperoniToppingTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public PepperoniToppingTileEntity(BlockPos pos, BlockState state) {
		super(ThePizzaTowerModModBlockEntities.PEPPERONI_TOPPING.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<PepperoniToppingTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<PepperoniToppingTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("pepperoni_topping");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Pepperoni Topping");
	}
